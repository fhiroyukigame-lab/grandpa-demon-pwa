const CACHE_NAME='grandpa-demon-v5710-title-fix-20260720';
const APP_SHELL=[
'./','./index.html','./style.css?v=5.7.10','./app.js?v=5.7.10',
'./manifest.webmanifest?v=5.7.10','./icon-192.png','./icon-512.png'
];
